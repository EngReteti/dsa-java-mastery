...
- [x] Day 3: Stacks - Implementing LIFO logic using Linked Lists (Push, Pop, Peek). ✅ ![Proof](docs/stacks_run.jpg)
- [x] Day 4: Queues - Implementing FIFO logic using Linked Lists (Enqueue, Dequeue). ✅ ![Proof](docs/queues_run.jpg)
